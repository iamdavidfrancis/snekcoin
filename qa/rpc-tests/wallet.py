...
#   c) node1 mines 61 blocks, so now nodes 0 and 1 have 500.000 snek, node2 has none. 
#   d) node0 sends 210.000 snek to node2, in two transactions (110.000 snek, then 100.000 snek).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # node0 should end up with 1.000.000 snek in block rewards plus fees, but
