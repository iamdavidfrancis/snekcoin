        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // Snekcoin: Disable free transactions
...
{
    // Snekcoin: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // Snekcoin: Add an increased fee for each dust output
        nFeeNeeded += GetSnekcoinDustFee(tx.vout, minTxFee);
    }
