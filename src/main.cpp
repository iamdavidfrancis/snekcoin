...
uint256 hashGenesisBlock("0xa8ccb4c61dc346600173980ab9e69eb8ed7e37b95270c0551c7c0d4588badba9");
...
const string strMessageMagic = "SnekCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2 * 60 * 60; // SnekCoin: 2 hours
static const int64 nTargetSpacing = 60; // SnekCoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal snekcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SnekCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4ed41d91990cb92368f10901055af4eaee7e0f40c79970b83bd6c95a954915fb");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Trump Declines to Release Full List of Mar-a-Lago Visitors";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1505595763; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 317672;

        if (fTestNet)
        {
            block.nTime    = 1505590147;
            block.nNonce   = 250115;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc602a9736e9d52c1d55b67744c2962f7705507c10af18ecd3032748d1237e878"));

        // If genesis block hash does not match, then *do not* generate new genesis hash.
