...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Snekcoin Core snekcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  snekcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded snekcoin transaction") + "\n" +
              "  snekcoin-tx [options] -create [commands]   " + _("Create hex-encoded snekcoin transaction") + "\n" +
              "\n";
