...
public:
    CMainParams() {
         ...
         * database.
         *
         * CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=4a5e1e, nTime=1505531270, nBits=0x1e0ffff0, nNonce=99943, vtx=1)
        ...
        vSeeds.push_back(CDNSSeedData("snekcoin.com", "seed.snekcoin.com"));
        vSeeds.push_back(CDNSSeedData("multisnek.org", "seed.multisnek.org"));
        vSeeds.push_back(CDNSSeedData("multisnek.org", "seed2.multisnek.org"));
        vSeeds.push_back(CDNSSeedData("snekr.snekcoin.com", "seed.snekr.snekcoin.com"));
        ...
        //TODO: fix this for snekcoin -- plddr
