    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Snekcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Snekcoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Snekcoin Core is shutting down...") + "<br /><br />" +
