    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpaceSnek = 40;
    ...
    QString titleText       = tr("Snekcoin Core");
    ...
    QString copyrightTextSnek  = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Snekcoin Core developers"));
    ...
    pixPaint.setFont(QFont(font, 10*fontFactor));
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpaceSnek,copyrightTextSnek);
