...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-Snekcoins (1,000,000)");
    case kBTC: return tr("Kilo-Snekcoins (1,000)");
    case BTC: return tr("Snekcoins");
    case mBTC: return tr("Milli-Snekcoins (1 / 1,000)");
    case uBTC: return tr("Micro-Snekcoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
