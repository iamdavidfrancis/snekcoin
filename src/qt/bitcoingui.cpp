...
// Copyright (c) 2014-2015 The Snekcoin Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Snekcoin Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // Snekcoin: load fallback font in case Comic Sans is not availble on the system
    ...
    // Snekcoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Snekcoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Snekcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and snekcoin: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Snekcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Snekcoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Snekcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Snekcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Snekcoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Snekcoin Core help message to get a list with possible Snekcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Snekcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Snekcoin network", "", count));
}
...
{
    QString strTitle = tr("Snekcoin"); // default title
