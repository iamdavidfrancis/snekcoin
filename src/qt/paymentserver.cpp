...
const QString BITCOIN_IPC_PREFIX("snekcoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/snekcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/snekcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/snekcoin-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start snekcoin: click-to-pay handler"));
        }
        else {
